  ...
  <body>
    ...
    <nav id="colorlib-main-nav" role="navigation">
      ...
      <div class="js-fullheight colorlib-table">
        <div class="img" style="background-image: url(public/images/bg_2.jpg);"></div>
        <div class="colorlib-table-cell js-fullheight">
          <div class="row no-gutters">
            <div class="col-md-12 text-center">
              <h1 class="mb-4"><a href="trang-chu" class="logo">My<br><span>Girl</span></a></h1>
              <ul>
                <li class="active"><a href="trang-chu"><span><small>01</small>Trang chủ</span></a></li>
                <li><a href="about"><span><small>02</small>Về chúng tôi</span></a></li>
                <li><a href="model.html"><span><small>03</small>Danh sách</span></a></li>
                <li><a href="blog.html"><span><small>04</small>Blog</span></a></li>
                <li><a href="contact.html"><span><small>05</small>Liên hệ</span></a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div id="colorlib-page">
      <header>
        <div class="colorlib-navbar-brand">
          <a class="colorlib-logo" href="trang-chu">My<br><span>Girl</span></a>
        </div>
      ...
      <section class="home-slider owl-carousel">
        ...
        <div class="slider-item" style="background-image: url('{{ $slide }}');">
      ...
      <section class="ftco-section-2">
	      <div class="container-fluid">
	        <div class="section-2-blocks-wrapper d-flex row no-gutters">
	          <div class="img col-md-6 ftco-animate" style="background-image: url('public/images/bg_5.jpg');">
	          </div>
	          <div class="text col-md-6 ftco-animate">
	            <div class="text-inner align-self-start">
	              
	              <h3 class="heading">CỘNG ĐỒNG THÔNG TIN</h3>
	              <p>{{-- Far far away,<strong>creative</strong> behind the word mountains, far from the countries Vokalia and Consonantia, there live the <strong>success</strong> blind texts. Separated they live in Bookmarksgrove --}}
	              Chúng tôi cung cấp những thông tin chính xác và chi tiết nhất về các cô gái mà bạn quan tâm ở khắp mọi miền tổ quốc.</p>
	              <ul class="my-4">
	              	<li><span class="ion-ios-checkmark-circle mr-2"></span> Tin cậy</li>
	              	<li><span class="ion-ios-checkmark-circle mr-2"></span> Đa dạng</li>
	              	<li><span class="ion-ios-checkmark-circle mr-2"></span> Bảo mật</li>
	              </ul>

	              <div class="row">
	              	<div class="col-md-7 ftco-animate">
	              		<div class="img-2 d-flex justify-content-center align-items-center" style="background-image: url('public/images/bg_1.jpg');">
	    	...
	    	<div class="container-fluid">
	    		<div class="row d-flex no-gutters">
	    			<div class="col-md-6 d-flex align-items-center heading-section ftco-animate bg-light">
	    				<div class="col-md-9">
								<div class="p-5">
			    				<h2 class="mb-4">CỎ NON</h2>
		              <p>Danh sách các cô gái mới vừa được thêm.</p>
	              </div>
              </div>
	    			</div>
	    			@php 
	    			...
	    			@if($count<9) @php $count++;  @endphp
	    			<div class="col-md-3 model-entry ftco-animate">
		    			<div class="model-img" style="background-image: url({{ $data  }});">
		    				<div class="name">
		    					<h3><a href="model-single.html">{{ $content[$count]->title }}</a></h3>
		    				</div>
		    				<div class="text">
		    					<h3><a href="model-single.html">{{ $content[$count]->title }}</a></h3>
	    ...
	    <section class="ftco-section testimony-section img" style="background-image: url(public/images/bg_7.jpg);">
	    	<div class="overlay"></div>
	      <div class="container">
	    ...
	    <section class="ftco-section-2">
	      <div class="container-fluid">
	        <div class="section-2-blocks-wrapper d-flex row no-gutters">
	          <div class="img col-md-6 ftco-animate" style="background-image: url('public/images/bg_6.jpg');">
	          </div>
	          <div class="text col-md-6 ftco-animate">
	            <div class="text-inner align-self-start">
	    ...
	    <section class="ftco-section">
	      <div class="container">
	        <div class="row d-flex">
	            ...
	            <h2 class="mb-4">NHẬT KÝ MỚI</h2>
	            <p class="mb-5">Thỏa sức chia sẻ những trải nghiệm của bạn. </p>
	    ...
	    <section class="ftco-quote ftco-animate">
	    	<div class="container">
	    		<div class="row d-flex">
	    			<div class="col-md-9 req-quote py-5 align-items-center img" style="background-image: url(public/images/bg_1.jpg);">
